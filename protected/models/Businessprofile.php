...
class Businessprofile extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('website, facebook_page, twitter_page, gplus_page, dti_number, phonenumber', 'length', 'max'=>50),
			array('openschedule', 'length', 'max'=>100),
			array('foundeddate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('business_id, website, openschedule, foundeddate, facebook_page, twitter_page, gplus_page, dti_number, phonenumber', 'safe', 'on'=>'search'),
		);
	}
